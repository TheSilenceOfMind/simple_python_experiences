...
def write_statistics_to_file(f, total_amount_of_words, d):
    """
    The method is used to write all statistics to file :
        1) count of words_entries
        2) total amount of words

    :param f: is filename - string
    :param total_amount_of_words in dictionary
    :param d: concrete dictionary
    :return: nothing
    """
...
for f in files:
    ...
    write_statistics_to_file(f, total_amount_of_words, d)